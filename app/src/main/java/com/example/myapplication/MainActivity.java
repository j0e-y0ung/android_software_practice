...
import service.SetQuietService;
...
public class MainActivity extends Activity {
    ...
    public  ListView list[] = new ListView[8];
    private TabHost tabs   = null;
    private TextView exitButton = null;
    private TextView calButton = null;
    public static DataBase db;
    public  Cursor[] cursor=new Cursor[8];
...
//			finish();
        ...
        calButton = (TextView)findViewById(R.id.calButton);
        ...
        list[7] = (ListView)findViewById(R.id.list);
        ...
        //audioManager.setStreamVolume(STREAM_RING, 0, 0);
        //为退出按钮绑定监听器
        ...
        Intent intent_quiet = new Intent(this, SetQuietService.class);
        startService(intent_quiet);
        SharedPreferences preferences = this.getSharedPreferences("switch", Context.MODE_MULTI_PROCESS);
    ...
    public  SimpleCursorAdapter adapter(int i){
        if(i<7) return new SimpleCursorAdapter(this, R.layout.list_v2,cursor[i],new String[]{"_id","classes","time1","time2"},new int[]{R.id.number,R.id.ltext0,R.id.ltext6,R.id.ltext7} );
        else return new SimpleCursorAdapter(this, R.layout.list_v2,cursor[i],new String[]{"_id","name","date","time"},new int[]{R.id.number,R.id.ltext0,R.id.ltext6,R.id.ltext7} );
    }
